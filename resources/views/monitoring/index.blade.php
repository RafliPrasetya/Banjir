    ...
    <div class="container my-5">
        ...
        <div class="d-flex flex-wrap justify-content-center gap-4 mb-3">
            ...
            <div class="card card-monitor text-center p-4 shadow-sm">
                ...
                <h2 id="ketinggian" class="fw-bold text-primary mb-1">{{ $sensor->ketinggian_air }} <span
                        class="fs-5">cm</span></h2>
            ...
            <div class="card card-monitor text-center p-4 shadow-sm">
                ...
                <h2 id="kelembapan" class="fw-bold text-info mb-1">{{ $sensor->kelembapan }} <span class="fs-5">%</span>
                </h2>
                <p class="tanggal text-muted small mb-0">
                    {{ Carbon::parse($sensor->tanggal)->translatedFormat('d M Y') }}
                </p>
...
@push('scripts')
    ...
    <script>
        ...
        function initChart(labels, suhuData, kelembapanData, ketinggianData) {
            if (sensorChart) {
                sensorChart.destroy(); // 🧨 Destroy chart lama jika sudah ada
            }
